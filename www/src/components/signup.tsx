...
const Signup = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className='space-y-4 w-full px-4 py-4'>
      ...
      <div>
        <label>Role:</label>
        <select value={role} onChange={(e) => setRole((e.target as HTMLInputElement).value)}>
      ...
      <button type="submit" className='px-4 py-2 bg-blue-700 rounded-sm text-white font-bold '>Sign Up</button>
    </form>
  )
}
